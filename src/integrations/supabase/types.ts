  ...
  public: {
    Tables: {
      ...
      cohort_coach_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "cohort_coach_assignments_cohort_id_fkey"
            columns: ["cohort_id"]
            isOneToOne: false
      ...
      cohort_module_deadlines: {
        ...
        Relationships: [
          {
            foreignKeyName: "cohort_module_deadlines_cohort_id_fkey"
            columns: ["cohort_id"]
            isOneToOne: false
            referencedRelation: "cohorts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "cohort_module_deadlines_programme_id_fkey"
      ...
      mentoring_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "mentoring_sessions_cohort_id_fkey"
            columns: ["cohort_id"]
            isOneToOne: false
            referencedRelation: "cohorts"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "mentoring_sessions_cohort_requirement_id_fkey"
      ...
      session_learning_reflections: {
        ...
        Relationships: [
          {
            foreignKeyName: "session_learning_reflections_enrollment_id_fkey"
            columns: ["enrollment_id"]
            isOneToOne: false
            referencedRelation: "programme_enrollments"
            referencedColumns: ["id"]
      ...
      sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sessions_cohort_requirement_id_fkey"
            columns: ["cohort_requirement_id"]
            isOneToOne: false
            referencedRelation: "cohort_requirement_dates"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      cohort_module_deadline_proposal: {
        Args: { p_end: string; p_programme_id: string }
        Returns: {
          completion_deadline: string
          module: Database["public"]["Enums"]["programme_module_type"]
          programme_id: string
      ...
      cohort_requirement_is_referenced: {
        Args: { p_id: string }
        Returns: boolean
      }
      ...
      cohort_requirement_legacy_spread: {
        ...
        Returns: {
          ...
          cohort_name: string
          completion_deadline: string
          legacy_first_due: string
          legacy_last_due: string
          module: Database["public"]["Enums"]["programme_module_type"]
          programme_id: string
          units: number
        }[]
      ...
      mentoring_sessions_without_requirement: {
        Args: never
        Returns: {
          cohort_id: string
          enrollment_id: string
