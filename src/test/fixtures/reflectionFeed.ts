...
export const reflectionFeedFixture: LearnerReflection[] = [
  ...
  { ...base, key: "triad_reflection:tr1", sourceType: "triad_reflection", sourceTable: "triad_reflections", sourceId: "tr1", module: "triads", occurredAt: "2026-03-08T09:00:00Z", body: "Triad reflection: silence is useful.", details: { answers: [{ question_id: "7d1a0000-0000-4000-8000-000000000001", question_key: "learned_as_coach", section: "coach", question: "What did I learn?", question_vi: "Bạn học được gì?", answer: "Triad reflection: silence is useful." }], round_number: 1 }, rating: 4, linkedSessionTable: "triad_sessions", linkedSessionId: "t1" },
