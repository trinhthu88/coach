  ...
  return (
    <section className="rounded-[14px] border p-[22px]" style={{ background: CARD, borderColor: LINE }}>
      ...
      <div className="mt-[18px] border-t border-[#eee8de] pt-4">
        <h3 className="mb-3 text-[9.5px] font-bold uppercase tracking-[.16em] text-[#9a938a]">
          {t("leaderDrawer.reference.coachingUtilisation")}
        </h3>
          ...
          <div className="mt-3 overflow-hidden rounded-xl border border-[#eee8de] bg-[#f6f3ee] px-3 pb-2.5 pt-3">
            <div className="flex min-w-0 gap-2">
              ...
              <div className="relative min-w-0 flex-1">
                ...
                <div
                  className="relative grid h-[142px] min-w-0 gap-1"
                  ...
                  {journey.map((point) => {
                    ...
                    return (
                      <div key={point.checkpoint_number} className="flex min-w-0 flex-col items-center justify-end">
                        <span className="mb-1 text-[8px] font-semibold text-[#6a6560]">{pct == null ? "—" : percent(pct)}</span>
                        <div className="flex h-[104px] w-full items-end justify-center">
                          <div
                            role="img"
                            aria-label={`${label}: ${pct == null ? "not available" : percent(pct)}`}
