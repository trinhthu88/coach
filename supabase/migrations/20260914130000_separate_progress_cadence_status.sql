-- Cadence/health is independent from enrollment and module lifecycle. Keep
-- pace_status in the cadence vocabulary even when completed units reach the
-- module total; completion remains available through the percentage and unit
-- fields.
