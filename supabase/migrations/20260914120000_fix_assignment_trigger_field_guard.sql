-- Keep every table-specific NEW field access inside the branch that isolates
-- the triggering table. assignment_submissions contains both quiz and
-- reflection records; only quiz assignments create quiz attributions.
