...
values ('a5000000-0000-0000-0000-000000000002','coach');
insert into public.coach_profiles(id,approval_status,peer_coaching_opt_in)
values ('a5000000-0000-0000-0000-000000000002','active',true);
...
values ('a5000000-0000-0000-0000-000000000010','coaching',true,
  '{"required":true,"required_units":2,"receive_limit":4,"distribution_mode":"flexible"}');
