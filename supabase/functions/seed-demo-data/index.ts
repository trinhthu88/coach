...
const COACHEES = [
  ...
  {
    email: "marcus.berg@demo.clariva.club",
    full_name: "Marcus Berg",
    bio: "Engineering leader growing a distributed platform team.",
    job_title: "VP Engineering",
    industry: "Software",
    location: "Stockholm, Sweden",
    timezone: "Europe/Stockholm",
    goals: "Delegate architecture decisions and coach my own managers better.",
  },
  {
